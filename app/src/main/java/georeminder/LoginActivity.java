...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signinPG = findViewById(R.id.signin_progressBar);
        signinText = findViewById(R.id.text_info_signin);
    ...
    public void onStart() {
        ...
        signinPG.setVisibility(View.GONE);
    }
    ...
    private void firebaseAuthWithGoogle(String idToken) {
        ...
        signinPG.setVisibility(View.VISIBLE);
